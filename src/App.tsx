...
const PageWrapper: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return <AnimatePresence mode="wait"><motion.div key={location.pathname} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.3 }}>{children}</motion.div></AnimatePresence>;
};

export default function App() {
  return <AuthProvider><FogProvider><Router><div className="flex flex-col min-h-screen"><Navbar/><main className="flex-grow"><Routes>
    <Route path="/" element={<PageWrapper><Home/></PageWrapper>}/><Route path="/directory" element={<PageWrapper><Directory/></PageWrapper>}/><Route path="/radio" element={<PageWrapper><Radio/></PageWrapper>}/><Route path="/marketplace" element={<PageWrapper><Marketplace/></PageWrapper>}/><Route path="/makers-hub" element={<PageWrapper><MakersHub/></PageWrapper>}/><Route path="/cafe" element={<PageWrapper><Cafe/></PageWrapper>}/><Route path="/volunteer" element={<PageWrapper><Volunteer/></PageWrapper>}/><Route path="/members" element={<PageWrapper><Members/></PageWrapper>}/><Route path="/feedback" element={<PageWrapper><Feedback/></PageWrapper>}/><Route path="/about" element={<PageWrapper><About/></PageWrapper>}/><Route path="/join" element={<PageWrapper><Join/></PageWrapper>}/><Route path="/resources" element={<PageWrapper><Resources/></PageWrapper>}/><Route path="/whats-on" element={<PageWrapper><WhatsOn/></PageWrapper>}/><Route path="/maker-stories" element={<PageWrapper><MakerStories/></PageWrapper>}/><Route path="/login" element={<PageWrapper><Login/></PageWrapper>}/><Route path="/dashboard" element={<PageWrapper><Dashboard/></PageWrapper>}/><Route path="/claim/:id" element={<PageWrapper><ClaimListing/></PageWrapper>}/><Route path="/submit-story" element={<PageWrapper><SubmitStory/></PageWrapper>}/><Route path="/makers-shop" element={<PageWrapper><MakersShop/></PageWrapper>}/><Route path="/privacy" element={<PageWrapper><Privacy/></PageWrapper>}/><Route path="/terms" element={<PageWrapper><Terms/></PageWrapper>}/><Route path="/accessibility" element={<PageWrapper><Accessibility/></PageWrapper>}/><Route path="/command" element={<PageWrapper><CommandCenter/></PageWrapper>}/><Route path="/discovery" element={<PageWrapper><Discovery/></PageWrapper>}/><Route path="/subscriptions" element={<Subscriptions/>}/><Route path="/changes" element={<ChangesDraft/>}/><Route path="/makers" element={<PageWrapper><MakersDirectory/></PageWrapper>}/><Route path="/support-the-makers" element={<PageWrapper><SupportMakers/></PageWrapper>}/><Route path="/become-a-maker" element={<PageWrapper><BecomeAMaker/></PageWrapper>}/><Route path="/notes" element={<PageWrapper><Notes/></PageWrapper>}/><Route path="/guides/:guideId" element={<PageWrapper><ProjectGuide/></PageWrapper>}/><Route path="/draft" element={<PageWrapper><DraftSpace/></PageWrapper>}/><Route path="/whats-on-agent" element={<WhatsOnAgent/>}/><Route path="/reset-password" element={<PageWrapper><ResetPassword/></PageWrapper>}/><Route path="/community" element={<PageWrapper><Community/></PageWrapper>}/><Route path="/apply" element={<PageWrapper><Apply/></PageWrapper>}/><Route path="/members-area" element={<PageWrapper><MembersArea/></PageWrapper>}/><Route path="/community-radio" element={<PageWrapper><CommunityRadio/></PageWrapper>}/><Route path="*" element={<PageWrapper><NotFound/></PageWrapper>}/>
