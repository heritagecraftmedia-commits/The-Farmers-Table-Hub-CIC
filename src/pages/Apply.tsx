  ...
  <div className="min-h-screen bg-brand-cream flex items-center justify-center px-4">
    <div className="text-center max-w-md">
      <div className="w-16 h-16 rounded-full bg-brand-olive/10 flex items-center justify-center mx-auto mb-8">
        <ClipboardList size={28} className="text-brand-olive" />
      </div>
      <h1 className="text-4xl font-serif mb-4">Apply to Join</h1>
      <p className="text-brand-ink/60 mb-3">Apply to become a listed maker, grower, or producer in the Farmers Table community.</p>
