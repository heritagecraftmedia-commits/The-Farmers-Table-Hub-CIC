  ...
  <div className="min-h-screen bg-brand-cream flex items-center justify-center px-4">
    <div className="text-center max-w-md">
      <div className="w-16 h-16 rounded-full bg-brand-olive/10 flex items-center justify-center mx-auto mb-8">
        <Radio size={28} className="text-brand-olive" />
      </div>
      <h1 className="text-4xl font-serif mb-4">Community Radio</h1>
      <p className="text-brand-ink/60 mb-3">Live and scheduled programming from local makers, growers, and community voices.</p>
