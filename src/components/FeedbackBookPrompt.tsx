  ...
  return (
    <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-[60] w-[calc(100%-2rem)] max-w-sm print:hidden">
      ...
      >
        ...
        <div className="bg-red-600 text-white px-5 py-3 font-black text-sm uppercase tracking-wider">
          Have your say
        </div>
          ...
          <div className="flex gap-3 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-brand-ink/70 mt-1">
                Good, bad or ugly — tell us what you really think.
              </p>
            </div>
          </div>

          <p className="mt-4 text-center text-sm font-black text-red-600 uppercase tracking-wide">
            Click anywhere here to start
          </p>
        </div>
      </div>
    </div>
